 ...
 */
function citygroups_content_block_info() {
  $blocks['citygroups_content_welcome'] = array(
    'info' => t('Welcome Message'),
    'cache' => DRUPAL_CACHE_PER_ROLE, // default
  );
  $blocks['citygroups_content_branding_header'] = array(
    'info' => t('Branding Header'),
    'cache' => DRUPAL_CACHE_PER_ROLE, // default
  );
  $blocks['citygroups_content_branding_footer'] = array(
    'info' => t('Branding Footer'),
    'cache' => DRUPAL_CACHE_PER_ROLE, // default
  );
  $blocks['citygroups_content_site_slogan'] = array(
    'info' => t('Site Slogan'),
    'cache' => DRUPAL_CACHE_PER_ROLE, // default
  );
  $blocks['citygroups_content_facebook_like'] = array(
    'info' => t('Facebook Like'),
    'cache' => DRUPAL_CACHE_PER_ROLE, // default
  );
  $blocks['citygroups_content_home_content'] = array(
    'info' => t('Home Content'),
    'cache' => DRUPAL_CACHE_PER_ROLE, // default
  );

  $blocks['citygroups_content_about'] = array(
    'info' => t('About'),
    'cache' => DRUPAL_CACHE_PER_ROLE, // default
  );
  $blocks['citygroups_content_map'] = array(
    'info' => t('Map'),
    'cache' => DRUPAL_CACHE_PER_ROLE, // default
  );
  return $blocks;
 ...
 */
function citygroups_content_block_view($delta = '') {
  switch ($delta) {
    case 'citygroups_content_welcome':
      $block['subject'] = '';
      $block['content'] = citygroups_content_contents('welcome');
      break;
      
    case 'citygroups_content_branding_header':
      $block['subject'] = '';
      $block['content'] = citygroups_content_contents('branding_header');
      break;
      
    case 'citygroups_content_branding_footer':
      $block['subject'] = '';
      $block['content'] = citygroups_content_contents('branding_footer');
      break;     

    case 'citygroups_content_site_slogan':
      $block['subject'] = '';
      $block['content'] = citygroups_content_contents('site_slogan');
      break;

    case 'citygroups_about_citygroups':
      $block['subject'] = '';
      $block['content'] = citygroups_content_contents('about_citygroups');
      break;         

    case 'citygroups_content_facebook_like':
    ...
    case 'citygroups_content_home_content':
      $block['subject'] = '';
      $block['content'] = citygroups_content_contents('home_content');
      break;


    case 'citygroups_content_about':
      $block['subject'] = '';
      $block['content'] = citygroups_content_contents('about');
      break; 

    case 'citygroups_content_map':
      $block['subject'] = '';
      $block['content'] = citygroups_content_contents('map');
      break;
  }
  return $block;
}
 ...
 */
function citygroups_content_contents($type) {
  $output = '';
