<?php
  $html_root = drupal_get_path('module', 'citygroups_group_categories');
?>
...
<head>
  ...
  <link rel="stylesheet" href="sites/all/themes/citygroups/css/style.css"  />
...
<div id="container" class="section container_12">
    <div id="header">
      <div class="header-logo-container grid_4 alpha">
        <div class="logo grid_6 alpha"><h1><a href="/"><img typeof="foaf:Image" src="http://citygroups.local/sites/all/themes/citygroups/images/city-groups-logo.png" alt="CityGroups" /></a></h1></div>
      </div>
