...
*/
      ...
      buttonTogglePolygon = function() {
        ...
        $('div.map-interface-instructions-tooltip').html('<div class="map-draw-tip"><h4>Draw Shape</h4><p>' + Drupal.t('Click to start drawing a shape. <strong>Double-Click</strong> on the last point to set the shape.') + '</p></div>');
      }
